...
|---|---|---:|---|
| `ollama-qwen-coder` | `qwen2.5-coder:3b` | 1 | `ollama-qwen-coder:11434` |
| `ollama-deepseek-r1` | `deepseek-r1:8b` | 0 | `ollama-deepseek-r1:11434` |
| `ollama-gemma3` | `gemma3:4b` | 0 | `ollama-gemma3:11434` |

Only `qwen2.5-coder:3b` is pulled by default. Scale another model by changing its `replicaCount` in the matching `charts/ollama/values-*.yaml`, adding or enabling a matching `ollama-models` value/app, committing, pushing, and letting Argo CD sync.
